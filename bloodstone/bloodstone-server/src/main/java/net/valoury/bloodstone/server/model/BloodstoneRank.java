...
public enum BloodstoneRank {
    ...
    IRON("valoury.rank.iron", 4, 4, 30, Duration.ofMinutes(10)),
    GOLD("valoury.rank.gold", 5, 6, 24, Duration.ofMinutes(7).plusSeconds(30)),
    DIAMOND("valoury.rank.diamond", 6, 8, 18, Duration.ofMinutes(5)),
    EMERALD("valoury.rank.emerald", 7, 10, 12, Duration.ofMinutes(2).plusSeconds(30));
