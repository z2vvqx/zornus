...
public final class PartyCommand {
    ...
    public static @NonNull BrigadierCommand create(PartyService partyService, ProxyServer proxyServer) {
        LiteralCommandNode<CommandSource> node = BrigadierCommand
                ...
                .then(PartyJoinCommand.create(partyService, proxyServer))
                ...
                .then(PartyModeratorCommand.createPromotion(partyService, proxyServer))
                .then(PartyModeratorCommand.createDemotion(partyService, proxyServer))
