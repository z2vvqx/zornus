...
public final class PartyProxyConstants {
    ...
    public static final String USAGE_ACCEPT = "<red><click:suggest_command:'/party accept '>/party accept <sender_name></click></red>";
    public static final String USAGE_JOIN = "<red><click:suggest_command:'/party join '>/party join <leader_name></click></red>";
    ...
    public static final String USAGE_REJECT = "<red><click:suggest_command:'/party reject '>/party reject <sender_name></click></red>";
    ...
    public static final String JOIN_SUCCESS = "<green>You joined <yellow><leader></yellow>'s party!</green>";
    public static final String JOIN_ERROR_NOT_LEADER = "<red>That player is not leading a party.</red>";
    public static final String JOIN_ERROR_PRIVATE = "<red>That party is private and requires an invitation.</red>";
    public static final String JOIN_ERROR_NOT_FOUND = "<red>That party no longer exists.</red>";
    ...
    public static final String KICK_ERROR_CANNOT_KICK_LEADER = "<red>You cannot kick the party leader.</red>";
    public static final String KICK_ERROR_CANNOT_KICK_MODERATOR = "<red>Party moderators cannot kick another moderator.</red>";

    public static final String PROMOTE_SUCCESS = "<green>Promoted <yellow><target></yellow> to party moderator.</green>";
    public static final String DEMOTE_SUCCESS = "<green>Demoted <yellow><target></yellow> from party moderator.</green>";
    ...
    public static final String SETTINGS_DISPLAY_AUTO_WARP = "<click:suggest_command:'/party settings autowarp '><#2DA0ED>autowarp</#2DA0ED></click> <dark_gray>[Personal]</dark_gray> <dark_gray>─</dark_gray> <white>Warp allowed members when you switch servers as leader: <value></white>";
    public static final String SETTINGS_DISPLAY_PRIVACY = "<click:suggest_command:'/party settings privacy '><#2DA0ED>privacy</#2DA0ED></click> <dark_gray>─</dark_gray> <white>Party privacy: <value></white>";
    ...
    public static final String UI_LIST_MEMBER_MODERATOR = "<#2DA0ED><member></#2DA0ED> <dark_gray>[Moderator]</dark_gray>";
    ...
    public static final String NOTIFICATION_MEMBER_PROMOTED = "<green><member> was promoted to party moderator.</green>";
    public static final String NOTIFICATION_MEMBER_DEMOTED = "<yellow><member> was demoted from party moderator.</yellow>";
    ...
    public static final String NOTIFICATION_INVITE_RECEIVED = "<green><player> invited you to join their party. <checkmark_action> <crossmark_action></green>";
    ...
    public static final List<String> HELP_COMMANDS = Arrays.asList(
            ...
            "<click:suggest_command:'/party accept '><#2DA0ED>accept <sender></#2DA0ED></click> <dark_gray>─</dark_gray> <white>Accepts a party invitation</white>",
            "<click:suggest_command:'/party join '><#2DA0ED>join <leader></#2DA0ED></click> <dark_gray>─</dark_gray> <white>Joins a public party</white>",
            "<click:suggest_command:'/party reject '><#2DA0ED>reject <sender></#2DA0ED></click> <dark_gray>─</dark_gray> <white>Rejects a party invitation</white>",
            ...
            "<click:suggest_command:'/party promote '><#2DA0ED>promote <member></#2DA0ED></click> <dark_gray>─</dark_gray> <white>Promotes a member to moderator</white>",
            "<click:suggest_command:'/party demote '><#2DA0ED>demote <member></#2DA0ED></click> <dark_gray>─</dark_gray> <white>Demotes a moderator</white>",
