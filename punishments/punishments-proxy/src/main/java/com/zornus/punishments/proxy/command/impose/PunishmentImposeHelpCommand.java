...
public final class PunishmentImposeHelpCommand {
    ...
    private static int handleDisplayHelp(@NonNull CommandContext<CommandSource> context, int page) {
        HelpUtils.sendHelpPage(context.getSource(), PunishmentProxyConstants.HELP_COMMANDS_IMPOSE, page, PunishmentProxyConstants.UI_HELP_PAGINATION_IMPOSE);
