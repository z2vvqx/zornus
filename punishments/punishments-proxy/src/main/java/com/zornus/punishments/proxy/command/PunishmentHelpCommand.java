...
public final class PunishmentHelpCommand {
    ...
    private static int handleDisplayHelp(@NonNull CommandContext<CommandSource> context, int page) {
        HelpUtils.sendHelpPage(context.getSource(), PunishmentProxyConstants.HELP_COMMANDS, page, PunishmentProxyConstants.UI_HELP_PAGINATION);
